...
package eu.roschi.obdkinesis.kcl.persistence.ddb;
...
import eu.roschi.obdkinesis.model.HttpReferrerPairsCount;
import eu.roschi.obdkinesis.model.ReferrerCount;
