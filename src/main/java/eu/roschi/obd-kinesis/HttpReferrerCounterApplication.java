...
import kcl.CountingRecordProcessorFactory;
import kcl.persistence.CountPersister;
import kcl.persistence.ddb.DynamoDBCountPersister;
import model.HttpReferrerPair;
...
public class HttpReferrerCounterApplication {
    ...
    private static final int COMPUTE_RANGE_FOR_COUNTS_IN_MILLIS = 30000;
